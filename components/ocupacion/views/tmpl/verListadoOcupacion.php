...
<head>
  ...
  <title>Listado General de Ocupaci&oacute;n</title>
  <script type="text/javascript">
    print();
  </script>
  <style type="text/css">
    #tabla_listaOcupacion {
      border: 1px solid #000;
      border-radius: 6px;
      -webkit-border-radius: 6px;
      -moz-border-radius: 6px;
    }
    #tabla_listaOcupacion td, #tabla_listaOcupacion th {
      padding: 5px;
    }
    #tabla_listaOcupacion thead {
    ...
    #tabla_listaOcupacion td:hover {
      background-color: #fff;
    }      
  </style>
</head>
<body>
  <table align="center" width="100%" cellpadding="0" cellspacing="0" id="tabla_listaOcupacion">
    <tr>
