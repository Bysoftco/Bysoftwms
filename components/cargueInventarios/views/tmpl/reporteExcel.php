...
class reporteExcel {
  ...
  function generarExcel($arreglo) {
    ...
    $this->objPHPExcel->getActiveSheet()->setCellValue("F1", "Código Referencia");
    $this->objPHPExcel->getActiveSheet()->setCellValue("G1", "Referencia");
    $this->objPHPExcel->getActiveSheet()->setCellValue("H1", "Fecha Ing.");
    $this->objPHPExcel->getActiveSheet()->setCellValue("I1", "Ubicacion");
    $this->objPHPExcel->getActiveSheet()->setCellValue("J1", "Tipo Ingreso");
    $this->objPHPExcel->getActiveSheet()->setCellValue("K1", "Piezas");
    $this->objPHPExcel->getActiveSheet()->setCellValue("L1", "Peso");
    $this->objPHPExcel->getActiveSheet()->setCellValue("M1", "Valor");
    $this->objPHPExcel->getActiveSheet()->setCellValue("N1", "Piezas Nal.");
    $this->objPHPExcel->getActiveSheet()->setCellValue("O1", "Piezas Ext.");
    ...
    foreach($arreglo['datos'] as $value) {
      ...
      $this->objPHPExcel->setActiveSheetIndex(0)
                  ...
                  ->setCellValue('F'.$i, $value['codigo_ref'])
                  ->setCellValue('G'.$i, $value['nombre_referencia'])
                  ...
                  ->setCellValue('K'.$i, number_format($value['cantidad'],2))
                  ->setCellValue('L'.$i, number_format($value['peso'],2))
                  ->setCellValue('M'.$i, number_format($value['valor'],2))
                  ->setCellValue('N'.$i, number_format($value['c_nal'],2))
                  ->setCellValue('O'.$i, number_format($value['c_ext'],2));
      // Acumula Totales
    ...
    $this->objPHPExcel->setActiveSheetIndex(0)
          ...
          ->setCellValue('K'.$i, number_format($tpiezas,2))
          ->setCellValue('L'.$i, number_format($tpeso,2))
          ->setCellValue('M'.$i, number_format($tvalor,2))
          ->setCellValue('N'.$i, number_format($tpiezas_nal,2))
          ->setCellValue('O'.$i, number_format($tpiezas_ext,2));
