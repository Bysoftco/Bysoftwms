...
class ClientesVista {
  ...
  function listadoClientes($arreglo) {
    $this->template->loadTemplateFile( COMPONENTS_PATH . 'clientes/views/tmpl/listadoClientes.php' );
  ...
  function vistaGeneral($arreglo) {
    $this->template->loadTemplateFile( COMPONENTS_PATH . 'clientes/views/tmpl/templateVista.php' );
    $this->template->setVariable('COMODIN', '' );
  ...
  function retornar_header($activar) {
    ...
    $tmpl->loadTemplateFile( COMPONENTS_PATH . 'clientes/views/tmpl/header_barra.php' );
  ...
  function verCliente($arreglo) {
    ...
    $template->loadTemplateFile( COMPONENTS_PATH . 'clientes/views/tmpl/verCliente.php' );
  ...
  function verTarifas($arreglo) {
    $template = new HTML_Template_IT();
    $template->loadTemplateFile( COMPONENTS_PATH . 'clientes/views/tmpl/verTarifas.php' );
    $template->setVariable('COMODIN', '' );
    $template->setVariable('numero_identificacion'   , $arreglo['datosCliente']['numero_documento'] );
    $contador = 0;
  ...
  function agregarTarifa($arreglo) {
    $this->template->loadTemplateFile( COMPONENTS_PATH . 'clientes/views/tmpl/agregarTarifa.php' );
    $this->template->setVariable('COMODIN', '' );
  ...
  function nuevoServicio($value, $codigo) {
    $template = new HTML_Template_IT();
    $template->loadTemplateFile( COMPONENTS_PATH . 'clientes/views/tmpl/servicios.php' );
    $template->setVariable('COMODIN', '' );
  ...
  function agregarReferencia($arreglo) {
    ...
    $this->template->setVariable('embalaje_referencia', isset($arreglo['embalaje_referencia'])?$arreglo['embalaje_referencia']:1);
  ...
  function verDocumentos($arreglo) {
    $template = new HTML_Template_IT();
    $template->loadTemplateFile( COMPONENTS_PATH . 'clientes/views/tmpl/verDocumentos.php' );
    $template->setVariable('COMODIN', '' );
    $template->setVariable('numero_identificacion', $arreglo['datosCliente']['numero_documento'] );
  ...
  function agregarDocumento($arreglo) {
    $this->template->loadTemplateFile( COMPONENTS_PATH . 'clientes/views/tmpl/agregarDocumento.php' );
    $this->template->setVariable('COMODIN', '' );
    $this->template->setVariable('cliente', $arreglo['numero_documento']);
    $this->template->show();
  }
