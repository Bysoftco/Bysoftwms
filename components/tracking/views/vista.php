...
class TrackingVista {
  ...
  function listadoTracking($arreglo) {
    $this->template->loadTemplateFile( COMPONENTS_PATH . 'tracking/views/tmpl/listadoTracking.php' );
    ...
    $this->template->loadTemplateFile( COMPONENTS_PATH . 'tracking/views/tmpl/filtroTracking.php' );
    $this->template->setVariable('COMODIN', '');
    $this->template->show();
	}
  
  function agregarTracking($arreglo) {
    $this->template->loadTemplateFile(COMPONENTS_PATH . 'tracking/views/tmpl/editarTracking.php');
    $this->template->setVariable('COMODIN', '');
    ...
    $this->template->setVariable('asunto',
      'DO: '.$arreglo['datosTracking']['sigla'].'-'.$arreglo['datosTracking']['do_asignado'].' - Documento Transporte: '.$arreglo['datosTracking']['doc_tte']);
  ...
  function verTracking($arreglo) {
    $this->template->loadTemplateFile( COMPONENTS_PATH . 'tracking/views/tmpl/verTracking.php' );
    $this->template->setVariable('COMODIN', '' );
