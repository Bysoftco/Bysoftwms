  ...
  <form name="datCliente" id="datCliente" method="post" action="javascript:enviarDatos()">
    <table align="center" width="90%" cellpadding="0" cellspacing="0" id="tabla_general" style="margin: 20px;">
      ...
      <tr>
        ...
        <td><input type="text" name="telefonos_faxes" id="telefonos_faxes" value="{telefonos_faxes}" /></td>
      </tr>
      <tr>
        ...
        <td><input type="text" name="correo_electronico" id="correo_electronico" class="email" value="{correo_electronico}" /></td>
      </tr>
      <tr>
        <td colspan="4"></td>
      </tr>
...
<script>
  ...
  function claseTipo(valor) {
	if(valor!=9) {$('#numero_documento').addClass('digits');}
	else {$('#numero_documento').removeClass('digits');}
  }
