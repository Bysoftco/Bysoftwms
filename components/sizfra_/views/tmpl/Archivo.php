...
class Archivo {
  ...
  /* Este Arreglo representa las extensiones de textovalidas del tipo de archivo que
     se pueden subir se utiliza en el método cargarInformacion y subir */
  var $extensionesTexto = array('txt','htm','html','hpml','inc','dat','xml','php');

  /* Este Arreglo define las equivalencias de los caractere especiales a reemplazar */
  ...
  /**
    * Archivo::desasignar()
    * Este método limpia o inicializa las variables de la clase
    * OPCIONAL
    * @return 
    */
  function desasignar() {
  ...
  /**
    ...
    * los parámetros del archivo, debe ser el primer método ha invocar después de 
  ...
  function cargarInformacion($nombreArchivo) {
    ...
    // El archivo si existe cargue la información
  ...
  /**
    ...
    * Este método se puede utilizar para volcar el contenido de un archivo a un
    * arreglo 
    * MÉTODO OPCIONAL.
    * @param $arreglo Arreglo donde se guardará el archivo
    * @return 
    */
  ...
  /**
    ...
    * Método que presta la utilidad de formatear el contenido de un archivo es decir 
    * reemplaza caracteres especiales específicamente las tildes
    * MÉTODO OPCIONAL
    * @return 
    */
  function eliminarCaracteresEspeciales() {
    $htmlTranslationTable = get_html_translation_table(HTML_ENTITIES, ENT_QUOTES);
    $translationTable = array_merge(array_flip($htmlTranslationTable));
  ...
  /**
    * Archivo::crear()
    * Método que presta la utilidad de crear archivos recibe como parámetro el 
    ...
    * este método, además actualiza las variables que almacenan los datos del archivo 
    * utilizando el método cargarInformacion para que la clase mantenga la información 
    * del archivo actual.
  ...
  /**
    ...
    * actual por este motivo debe llenarse esta variable directamente o preferiblemente
    * instanciando la clase y utilizando el método cargarInformacion.
    * @return 
    */
  function borrar() {
  ...
  /**
    * Archivo::copiar()
    * Función utilizada para crear una copia del archivo  
    * 
  ...
  /**
    ...
    * @param  $nombreDirectorio  Directorio en donde se pondrá el archivo
  ...
  function subir($variablePost, $nombreDirectorio, $sobreEscribir = true, $modificarArchivo = false) {
    if(isset($_FILES[$variablePost]['tmp_name'],$_FILES[$variablePost]['name']) and $_FILES[$variablePost]['size'] > 0) {
  ...
  /**
    ...
    * un archivo, recibe como parámetros el nombre del archivo a renombrar y el
    * nuevo nombre
    * 
  ...
  /**
    * Archivo::escribirContenido()
    * Este método presta la funcionalidad de limpiar el archivo es decir borrar su
    * contenido.
    * 
    * @param string $contenido Contenido del archivo
    * @return 
  ...
  /**
    * Archivo:: mover()
    * Este método presta la funcionalidad de cambiar la ubicación de un archivo
    * 
    * @param string $contenido Contenido del archivo
    * @return 
    */
  ...
  /**
    * Archivo::permisos()
    * Carga los permisos de un archivo es decir obtiene los parámetros que dan
  ...
  /**
    ...
    * Arma una cadena según los permisos del archivo para mostrar esta información 
    * de manera que sea legible.
    * 
    * @return 
    */
