...
class SizfraVista {
  ...
  function listadoSizfra($arreglo,$datosInterfaz) {    
    ...
    foreach($arreglo['datos'] as $value) {
      ...
      $this->template->setVariable('peso_neto', $value['peso_neto']);
      ...
      $this->template->setVariable('bandera', $value['destino']);
      ...
      $linea = "0\t".$value['operacion']."\t".$value['sku_proveedor']."\t".$value['peso_bruto']."\t";
