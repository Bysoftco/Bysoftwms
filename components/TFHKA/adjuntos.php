...
$options = array('exceptions' => true, 'trace' => true);
    ...
    foreach($_FILES as $ajdunto => $unArchivo){
        ...
        $params->tokenEmpresa = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"; //SE DEBE SETEAR ESTE VALOR (SUMINSTRADO POR TFHKA)
        $params->tokenPassword = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"; //SE DEBE SETEAR ESTE VALOR (SUMINSTRADO POR TFHKA)
