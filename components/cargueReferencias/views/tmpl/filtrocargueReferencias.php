...
<body>
<div id="wincargueref" title="Cargue Masivo de Referencias" style="font-size: 14px;">
  <div class="container-fluid mt-2">
    <div class="row">
      <div class="col-md-12">  
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <p><span><strong>CARGUE DE REFERENCIAS DESDE EXCEL</strong></span></p>
          </div>
          <div class="card-body mt-2">
            <form action="" method="POST" enctype="multipart/form-data" name="archivoSeleccionado">
              ...
              <button type="submit" name="cargar_datos_excel" class="btn btn-primary mt-3" id="cargar_datos">Cargar</button>
            </form>
          </div>
        </div>
      </div>
...
<script>
  ...
  // Muestra la Ventana de Cargue de Referencias
  $( "#wincargueref" ).dialog( "open" );

  function cargarArchivo(nomArchivo) {
    $( "#wincargueref" ).dialog( "close" );
    ...
    Req.open("POST", "index_blank.php?component=cargueReferencias&method=procesarArchivo", true);
    ...
    Req.onreadystatechange = function() {
      if(Req.readyState == 4 && Req.status == 200) {
        ...
        if(msm=="Importado") {
          alert('Cargue de REFERENCIAS satisfactoriamente');
          location.reload();
        } else {
