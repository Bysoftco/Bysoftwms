...
<form name="envioDatos" id="envioDatos" action="javascript:EnviarFormulario()">
	<table align="center" width="100%" cellpadding="0" cellspacing="0" id="tabla_general">
		...
		<tr>
			<td>Nombre Perfil *</td>
			<td>
				<input alt="<br />* Debe ingresar <b>Nombre Perfil</b> para poder continuar" class="login estiloPerfiles {required:true}" type="text" name="nombre" id="nombe" value="{nombre_perfil}" />
			</td>
		</tr>
		<tr>
			<td>Descripci&oacute;n *</td>
			<td>
				<textarea alt="<br />* Debe ingresar <b>Descripci�n</b> para poder continuar" class="textarea_login estiloPerfiles {required:true}" name="descripcion" id="descripcion">{descripcion}</textarea>
			</td>
		</tr>
		<tr>
