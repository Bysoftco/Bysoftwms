...
<body>
  ...
  <table align="center" width="100%" cellpadding="0" cellspacing="0" id="tabla_ordenacondicionar">
    ...
    <!-- END ROW -->
    <tr>
      <td colspan="9" style="font-size: 12px;"><b>T O T A L E S</b></td>
    ...
    <tr>
      <td colspan="2"style="font-size:12px;"><b>RECIBIDO POR</b></td>
      <td colspan="4"></td>
      <td colspan="3"style="font-size:12px;"><b>% RENDIMIENTO (MIN 98%)</b></td>
      <td colspan="4"></td>
    </tr>
    <tr>
      <td colspan="2"style="font-size:12px;"><b>RESPONSABLE DE PRODUCCI&Oacute;N</b></td>
      <td colspan="4"></td>
      <td colspan="3"style="font-size:12px;"><b>APROBADO DT. T&Eacute;CNICA/CALIDAD</b></td>
      <td colspan="4"></td>
    </tr>
    <tr>
      <th colspan="13"><b>OBSERVACIONES</b></th>
    </tr>
    <tr><td colspan="13" style="font-size:12px;height:70px;" colspan="12">{observaciones}</td></tr>
    <tr>
      <td colspan="13">
        <table width="100%">
          <tr>
