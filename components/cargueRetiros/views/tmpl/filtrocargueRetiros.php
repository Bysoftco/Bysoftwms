...
<body>
<div id="wincargueret" title="Cargue Masivo de Retiros" style="font-size: 14px;">
  <div class="container-fluid mt-2">
    <div class="row">
      <div class="col-md-12">  
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <p><span><strong>CARGUE DE RETIROS DESDE EXCEL</strong></span></p>
          </div>
...
<script>
  ...
  $( "#wincargueret" ).dialog( "open" ); 

  function cargarArchivo(nomArchivo) {
    $( "#wincargueret" ).dialog( "close" );
    ...
    Req.open("POST", "index_blank.php?component=cargueRetiros&method=procesarArchivo", true);
    ...
    Req.onreadystatechange = function() {
      if(Req.readyState == 4 && Req.status == 200) {
        ...
        if(msm=="Importado") {
          alert('Cargue de MOVIMIENTOS RETIROS satisfactoriamente');
          location.reload();
        } else {
