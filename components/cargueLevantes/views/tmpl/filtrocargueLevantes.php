...
<body>
<div id="wincarguelev" title="Cargue Masivo de Levantes" style="font-size: 14px;">
  <div class="container-fluid mt-2">
    <div class="row">
      <div class="col-md-12">  
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <p><span><strong>CARGUE DE LEVANTES DESDE EXCEL</strong></span></p>
          </div>
...
<script>
  ...
  // Muestra la Ventana de Cargue de Salidas
  $( "#wincarguelev" ).dialog( "open" ); 

  function cargarArchivo(nomArchivo) {
    $( "#wincarguelev" ).dialog( "close" );
    ...
    Req.open("POST", "index_blank.php?component=cargueLevantes&method=procesarArchivo", true);
    ...
    Req.onreadystatechange = function() {
      if(Req.readyState == 4 && Req.status == 200) {
        ...
        if(msm=="Importado") {
          alert('Cargue de MOVIMIENTOS LEVANTES satisfactoriamente');
          location.reload();
        } else {
