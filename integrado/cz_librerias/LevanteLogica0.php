...
class LevanteLogica {
  ...
  function addItemRetiro($arregloDatos) {
    ...
    $this->datos->addItemRetiro($arregloDatos);
	/*
	 Inmediataeemente despues de hacer el retiro, se verifica si el registro  queda o no con inventario
   ...
   //echo "XXXXXXXXXXXXXXXXXYYYYYYYYYYYYYYYYYYYYYYYYYYYY NACI $cantidad_retirada_naci YYYYYYYYYYYYYYYYYYYY EXT $cantidad_retirada_ext  ";
	if($cantidad_retirada_naci <=0 && $cantidad_retirada_ext <=0 ){
		...
		//echo "READY TO DELETE  DELETE DELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETE";
	}
      ...
      if($arregloDatos[cierre]) {
        ...
        if(!$unaOrden->addOrden($arregloDatos)) {
          ...
          $this->datos->getDatosInventario($arregloDatos);
		   ...
		   //echo "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX".$arregloDatos[id_item];
