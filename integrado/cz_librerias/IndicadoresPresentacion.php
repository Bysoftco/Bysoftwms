  ...
  //Funcion encargada de Construir los Parametros para Un Grafico , pinta y pasa los for
	...
	function indicadorIngresos($arregloDatos) {
		...
		while($this->datos->fetch()) {
			...
			$this->plantilla->setVariable('color', $colores[$color]);
			$this->plantilla->setVariable('valores', number_format($this->datos->valores,0,',','.'));
			$this->plantilla->setVariable('enero_valor', number_format((double)$this->datos->enero,0,',','.'));
			$this->plantilla->setVariable('febrero_valor', number_format((double)$this->datos->febrero,0,',','.'));
			$this->plantilla->setVariable('marzo_valor', number_format((double)$this->datos->marzo,0,',','.'));
			$this->plantilla->setVariable('abril_valor', number_format((double)$this->datos->abril,0,',','.'));
			$this->plantilla->setVariable('mayo_valor', number_format((double)$this->datos->mayo,0,',','.'));
			$this->plantilla->setVariable('junio_valor', number_format((double)$this->datos->junio,0,',','.'));
			$this->plantilla->setVariable('julio_valor', number_format((double)$this->datos->julio,0,',','.'));
			$this->plantilla->setVariable('agosto_valor', number_format((double)$this->datos->agosto,0,',','.'));
			$this->plantilla->setVariable('septiembre_valor', number_format((double)$this->datos->septiembre,0,',','.'));
			$this->plantilla->setVariable('octubre_valor', number_format((double)$this->datos->octubre,0,',','.'));
			$this->plantilla->setVariable('noviembre_valor', number_format((double)$this->datos->noviembre,0,',','.'));
			$this->plantilla->setVariable('diciembre_valor', number_format((double)$this->datos->diciembre,0,',','.'));
			$this->plantilla->setVariable('convencion' , $this->datos->datos);
			$this->plantilla->setVariable('n', $n);
			...
			$this->plantilla->setVariable('enero_retiro' , number_format((double)$retiros->enero,0,',','.'));
			$this->plantilla->setVariable('febrero_retiro' , number_format((double)$retiros->febrero,0,',','.'));
			$this->plantilla->setVariable('marzo_retiro' , number_format((double)$retiros->marzo,0,',','.'));
			$this->plantilla->setVariable('abril_retiro' , number_format((double)$retiros->abril,0,',','.'));
			$this->plantilla->setVariable('mayo_retiro' , number_format((double)$retiros->mayo,0,',','.'));
			$this->plantilla->setVariable('junio_retiro' , number_format((double)$retiros->junio,0,',','.'));
			$this->plantilla->setVariable('julio_retiro' , number_format((double)$retiros->julio,0,',','.'));
			$this->plantilla->setVariable('agosto_retiro' , number_format((double)$retiros->agosto,0,',','.'));
			$this->plantilla->setVariable('septiembre_retiro' , number_format((double)$retiros->septiembre,0,',','.'));
			$this->plantilla->setVariable('octubre_retiro' , number_format((double)$retiros->octubre,0,',','.'));
			$this->plantilla->setVariable('noviembre_retiro' , number_format((double)$retiros->noviembre,0,',','.'));
			$this->plantilla->setVariable('diciembre_retiro' , number_format((double)$retiros->diciembre,0,',','.'));
