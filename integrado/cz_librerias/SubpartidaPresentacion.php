<?php	 /*
	 ...
	 Clase encargada de Construir la Interfaz Grafica Para el Modulo de Subpartida
...
class SubpartidaPresentacion {
    ...
    function SubpartidaPresentacion (&$datos) {
    ...
    $this->plantilla->loadTemplateFile(PLANTILLAS . 'subpartidaMaestro.html', true, true);
