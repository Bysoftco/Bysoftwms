...
var mPrefix = " "
var mSuffix = "\n This is a required field, Please digitel now.\n"
// p is an abbreviation for "prompt"
var pEntryPrompt = "Por favor digite "
// i is an abreviation for "invalid"
var iPrefix = "You digit invalid information. "
var iSuffix = "\n This is a required field, Please digitel now.\n"
...
function validarFecha(fecha,validarDias,validarMes,validaMayor){
	...
	diaFecha	=fecha.substring (6, 8);
		var mesFechaAux = mesFecha/1-1;
		
		var fechaAux = new Date(anioFecha	, mesFechaAux, diaFecha	);
	...
	if(anios != 0){
		alert('Verifique, el aÒo no es el actual '+fechaHoy.getYear());
	}
	...
	if(validaMayor){
		...
		//if(dia < 0   && mes <= 0 ){
			...
			//return false; 
		//}
		var msegActual = fechaHoy.getTime();
			var msegFecha1 = fechaAux.getTime();
			
			var Diferencia = msegActual - msegFecha1;
			
			Diferencia /= 86400000;
			if (Diferencia < 0) {
				alert('La Fecha Ingresada No puede ser mayor a la fecha atual ');
				return false; 
